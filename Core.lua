...
local skinNameDark = '|cff8080ffThe War Within Dark|r'
...
local skinTableDark = {
	...
	instance_cprops = {
		...
		["row_info"] = {
			...
			["icon_file"] = "Interface\\AddOns\\Details_TWW\\Textures\\ClassIconsTWW_dark",
			start_after_icon = false, --
			icon_offset = { -30, 0 }, --
			--
			["textL_show_number"] = true, --
			...
			["textR_separator"] = ",",
			["use_spec_icons"] = true, --
			["spec_file"] = "Interface\\AddOns\\Details_TWW\\Textures\\specs_dark", --
			icon_size_offset = 1.2,
		},
		--
		menu_icons_alpha = 1,
...
function TWW:RegisterSkin()
    ...
    Details:InstallSkin(skinNameDark, skinTableDark)
end
